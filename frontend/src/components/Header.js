                        ...
                        <div className="nav-left">
                            <a className="brand">
                                <div className="mascot-container">
                                    <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/purple-mascot-zBlxf4xblDX3NHt8mWIWtX8Yzwb5PO.png" 
                                        alt="Purple Chameleon Mascot" 
                                        className="mascot-image"/>
                                </div>
                                TropiCode
                            </a>
                            <a onClick={() => handleTabSwitch('home')} className="nav-button">
                            ...
                            <a onClick={() => handleTabSwitch('classes')} className="nav-button">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M22 10v6M2 10l10-5 10 5-10 5z"/>
                                    <path d="M6 12v5c3 3 9 3 12 0v-5"/>
                                </svg>
                            ...
                            <a onClick={() => handleTabSwitch('homework')} className="nav-button">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/>
                                </svg>
                                <span>Homework</span>
